...
public class DayMovingEverage {
    // contructing a class for each date line object
    ...
    // returns the list of dates that show bulish signals
    public ArrayList<String> getBulishDays(File file) {
        ...
        try {
            ...
            try {
                ...
                while ((line = reader.readLine()) != null && line.length() == 16) {
                ...
                // if there was no 50 days in the file or no bulish signals occured - return string "NULL" as well
                if(numDays < 50 || bulishDays.size() == 0){
                    bulishDays.add("NULL");
                }
    ...
    public static void main(String[] main) throws java.io.FileNotFoundException {
        File file = new File(("/Users/student/Dropbox/inputnodays.txt"));
